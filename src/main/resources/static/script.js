...
function kjop(){
    ...
    //else if (telefonnr.startsWith('4') || telefonnr.startsWith('9'))){}
    //Fikk ikke til .startsWith funksjonen...
...
function slett(){
    billetter.length = 0;
    document.getElementById("alleBilletteretter").innerHTML="";
}
